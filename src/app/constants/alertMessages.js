...
export const BUSINESS_PROFILE_CREATED =
  "You have successfully created your business profile.";
export const BUSINESS_PROFILE_UPDATED =
  "You have successfully updated your business profile.";
export const FORGET_PASSWORD_SEND =
  "Your password was successfully sent to your business email address.";
export const SURE_UNLINK_ACCOUNT =
  "Do you really want to Disconnect the account?";
...
export const DELETECATEGORY = {
  ...
  message: (categoryName = "") => {
    return `Are you sure to delete category - ${categoryName} of the category?`;
  },
  button1: "Cancel",
  button2: "Delete",
};
...
export const BANK_CONNECTION = {
  ...
  message:
    "Connect your bank and get a complete picture of your cash flow in one place.",
  button1: "Cancel",
  button2: "Connect",
};
