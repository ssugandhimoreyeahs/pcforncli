...
export const arDataReducer = (state = ARInitalState, action) => {
    ...
    switch(action.type){
        ...
        case FETCH_INCOMMINGAR_REQUEST: return{
        ...
        case FETCH_INCOMMINGAR_SUCCESS: return{
        ...
        case FETCH_INCOMMINGAR_ERROR: return {
