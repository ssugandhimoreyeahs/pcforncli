...
export const insightsDataReducer = (state = insightsInitialData, action) => {
    ...
    switch(action.type){
        ...
        case FETCH_INSIGHTS_REQUEST: return{
        ...
        case FETCH_INSIGHTS_SUCCESS: return{
        ...
        case FETCH_INSIGHTS_ERROR: return {
...
export const fetchInsightsAsyncCreator = () => {
    return (dispatch) => {
        ...
        getInsights().then((insightsResponse) => {
            if(insightsResponse.result == true){
                ...
                dispatch(fetchInsightsError({ errorMsg:"Error While Fetching Incoming Ar" }));
            }
