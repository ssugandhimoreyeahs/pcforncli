...
export default class FeedbackScreen extends Component {
  ...
  saveFeedBack = () => {
    ...
    composeSuggestionsData =
      composeSuggestionsData.length == 0 ? " " : composeSuggestionsData;
    ...
    sendUserFeedbackData(feedbackFormData)
      .then((response) => {
        if (response.result == true) {
          ...
          console.log(
            "Feedback api response error inside else part- ",
            response
          );
  ...
  handleFeedbackImageSelect = async () => {
    ...
    ImagePickerRN.showImagePicker(options, (response) => {
      if (response.didCancel) {
        ...
        this.setState({
          feedbackImages: [...this.state.feedbackImages, response],
        });
      }
    });
  ...
  render() {
    const { feedbackImages } = this.state;
    return (
      <Root headerColor={"#F1F3F5"} footerColor={"#FFF"} barStyle={"dark"}>
          ...
          <View style={styles.submitContainer}>
            ...
            >
              ...
              {feedbackImages.length < 3 ? (
                <TouchableOpacity
                  onPress={() => {
                    this.handleFeedbackImageSelect();
                  }}
                >
            ...
            <View style={{ justifyContent: "center", alignItems: "center" }}>
              <Button
                ...
                title="Submit"
                disabled={
                  this.state.feedbackText.trim().length > 0 ? false : true
                }
