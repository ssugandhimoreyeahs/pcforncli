...
handleNoQbButton = async () => { 
  ...
  render() {
    ...
    const buttonCondition = (this.state.bench || this.state.sage || this.state.wave || this.state.xero) && (!this.props.navigation.getParam("isOneTimeNoQbSend"));
    return (
      <React.Fragment>
        <Spinner visible = {this.state.isSpinner} />
        <View style={{flexDirection:'row', width:'73%',marginTop:'1%',alignSelf:"flex-start",justifyContent:'space-between',}}>
        ...
        <View style={{ flexDirection: "column", alignItems: "center",marginTop:"7%",height:34,}}>
            <Text style={{ alignSelf: "center", fontFamily:'System', fontSize:15,fontWeight:'bold',height:30 }}>{
          ...
          style={{ 
            ...
            height:'15%'}}>
              ...
              >
                ...
                >
                  <Text style={{textAlign:'center', fontFamily:"System", fontSize:12,fontWeight:'bold'}}>Other</Text>
                </Card>
              </TouchableOpacity>
              }
              ...
              
              {
                  buttonCondition &&
                <Button
                  containerStyle={{ width: "92%",alignSelf:'center',marginTop:'8%',}}
        ...
        <DialogInput isDialogVisible={this.state.isDialogVisible}
            title={"Other"}
            message={<Fragment><Text>Please tell us which accounting software you are using for your business.</Text>{
              isShowPleaseEnter == true ? <Text style={{ color:"red" }}>{ `\n\nPlease Enter Software Name` }</Text> : null
            }</Fragment>}
        ...
        >
          ...
          >
            <Text style={{ fontSize: 17, fontWeight: "bold", textAlign: "center" }}>Other</Text>
...
export default DetectPlatform(LedgerIntegration, styles.container);
