    ...
    return (
      <Root headerColor={"#fff"} footerColor={"#fff"} barStyle={"dark"}>
        <View style={styles.container}>
          ...
          {isBodyLoaded == true ? (
            showReloadingPage == true ? (
              ...
              <ScrollView>
                <View
                  style={{ marginTop: 10, flexDirection: "row", width: "100%" }}
                >
                  <View
                    style={{
                      width: "8%",
        ...
        <Button title="Add company logo" type="clear" /> */}
                ...
                <TouchableOpacity onPress={this.handleChooseBusinessProfilePic}>
                  <Text
                    style={{
                      fontFamily: "System",
                      fontSize: 15,
