      ...
      return (
        <React.Fragment>
            <View style={{justifyContent:'center',width:"70%", height:'50%',alignSelf:"center"}}>
              <Text style={{fontWeight:'bold',textAlign:'center',fontSize:20,alignSelf:'center'}}>Your Quickbook account has been successfully connected to PocketCFO</Text>
            </View>
            <View style={{justifyContent:'flex-end', width:"70%", height:"50%",marginBottom:'10%', alignSelf:"center"}}>
              {/* <Button 
                  ...
                  <TouchableOpacity  onPress={()=>{ this.handleQbCopyFunction();this.props.navigation.getParam("redirectTo")(); }} style={{backgroundColor: "#007AFF",height:48,width:"50%",borderRadius:25,alignSelf:"center", justifyContent:"center"}}><Text style={{ textAlign:"center",color:"#FFFFFF" }}>Back</Text></TouchableOpacity>
            </View>
         </React.Fragment>
      );
    }
