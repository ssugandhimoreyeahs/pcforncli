  ...
  render() {
    return (
      <React.Fragment>
        ...
        />
        {  this.state.isUserExistFlag && <Text style={{color:"red",alignSelf:"center"}}>Sorry, that username already exists!</Text>}
        <Button
...
export default DetectPlatform(Email,styles.container);