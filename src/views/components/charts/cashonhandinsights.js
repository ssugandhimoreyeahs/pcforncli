...
class CashOnHandinsights extends React.Component {
  ...
  loadCohInsights = () => {
    ...
    if (
      ...
      insightsData.Coh == undefined ||
      insightsData.Coh.type == undefined ||
      insightsData == null ||
      insightsData.Coh == null ||
      insightsData.Coh.type == null
    ) {
      return (
        <View>
          <View
        ...
        <ScrollView>
          ...
          <View
            style={{
              ...
              backgroundColor:
                insightsData.Coh.insightText == false ? "#FFE8DD" : "#E5FCEA",
              alignItems: "center",
            }}
          >
          ...
          >
            ...
            {insightsData.Coh.insightData.map((singleApiCohData, index1) => {
              return (
                <View key={index1} style={styles.viewdes}>
