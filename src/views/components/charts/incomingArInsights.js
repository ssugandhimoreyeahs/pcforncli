...
function Separator() {
 ...
 class IncomingARInsights extends React.Component{
  ...
  useFulComponent = () => {
    return(
      <View style={{width:"100%", backgroundColor:'#FFFFFF', height:100,marginBottom:10}}>
             <Text style={{width:166, height:16,marginTop:20, alignSelf:'center', fontSize:12}}>How do you like the insights?</Text>
  
       <View style={{backgroundColor:'#FFFFFF', flexDirection:'row', justifyContent:'space-between', marginTop:24, marginLeft:60,marginRight:60,height:80}}>
  ...
  feedbackComponent = () => {
    return(
      <View style={{width:"100%", backgroundColor:'#FFFFFF', marginBottom:10, height:100,}}>
    ...
    return(
      <ScrollView>
    <View style={{flexDirection:'row', width:'73%',height:45,marginTop:'3%',alignSelf:"flex-start",justifyContent:'space-between',}}>
    ...
    <View style={{width:"100%", height:131, flexDirection:'column', backgroundColor:'#FFE8DD', alignItems:'center',}}>
     <View style={{marginTop:42,}}>
      <Text style={styles.text1}>Your cash balance has decreased</Text>
      <Text style={styles.text1}>more than 50% from last month.</Text></View>
     </View>

     <View style={{width:"100%", height:740, flexDirection:'column', backgroundColor:'#FFFFFF',}}>
         <Text style={styles.title}>Frequently Late Customers</Text>

            <View style={{flexDirection:'column', marginLeft:24, marginRight:24, marginTop:24, height:150}}>
         ...
         <View style={{width:"100%", height:500, flexDirection:'column', backgroundColor:'#FFFFFF',}}>
...
export default DetectPlatform(IncomingARInsights, styles.margins);