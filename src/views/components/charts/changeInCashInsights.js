...
class ChangeInCashInsights extends React.Component{
  ...
  <Text style={styles.header}>Change in Cash Insights</Text>
</View>
   <View style={{width:"100%", height:131, flexDirection:'column', backgroundColor:'#FFE8DD', alignItems:'center',}}>
    ...
    <View style={{width:"100%", height:550, flexDirection:'column', backgroundColor:'#FFFFFF',}}>
...
export default DetectPlatform(ChangeInCashInsights, styles.margins);