...
import DetectPlatform from "../../../DetectPlatform";
 ...
 class SalesInsights extends React.Component{
  ...
  return(
  <ScrollView>
    <View style={{flexDirection:'row', width:'66%',height:45,marginTop:'3%',alignSelf:"flex-start",justifyContent:'space-between',}}>
...
export default DetectPlatform(SalesInsights, styles.margins);