  ...
  renderBlock = ({ blockNo, blockText, marginTop }) => {
    return (
      ...
      >
        ...
        <View style={{ width: "87%" }}>{blockText}</View>
      </View>
    );
  };
  render() {
      ...
      <ScrollView style={styles.container}> 
        ...
        <View style={{ marginTop: 40, width: "90%", alignSelf: "center" }}>
          <View style={{ alignSelf: "flex-start" }}>
            <Text
              style={{ color: "#1D1E1F", fontSize: 17, fontWeight: "bold" }}
            >
              {"How to improve"}
            </Text>
          </View>
        ...
        <View
          style={{ backgroundColor: "#EEEFF1", height: 15, marginTop: 40 }}
        />
        ...
        >
          <Text style={{ fontSize: 13, color: "#1D1E1F" }}>
    ...
    data: (navigation) => {
      return (
        <Text style={{ fontSize: 16, color: "#000", textAlign: "left" }}>
          ...
          <Text
            onPress={() => {
              navigation.navigate("NewExpenseByCategoryParent");
            }}
...
export default ExpenseByCategoryInsights;
