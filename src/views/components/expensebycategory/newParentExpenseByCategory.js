...
class ExpenseByCategory extends Component {
      ...
      <Fragment>
        <View style={{ height: 370, backgroundColor: "#FFF" }}>
          ...
          <View style={styles.filterButton}>
            ...
            >
              <AntDesign color={"#030538"} name={"left"} size={15} />
            </TouchableOpacity>
            <Text
              style={{ alignSelf: "center", color: "#030538", fontSize: 12 }}
            >
            ...
            >
              <AntDesign name={"right"} color={"#030538"} size={15} />
            </TouchableOpacity>
          </View>
  ...
  renderSingleCategory = ({ currentIndex, item }) => {
    ...
    return (
      <Fragment>
          ...
          <View style={styles.categoryIconStyle}>
            {categoryIcon.isIcon == true ? (
              ...
              <View
                style={{
                  borderRadius: 50,
                  borderColor: categoryIcon.backgroundColor,
                  justifyContent: "center",
                  alignItems: "center",
                  height: 40,
                  width: 40,
          ...
          <View style={styles.categoryRenderStyle}>
            ...
            <View style={styles.categoryTitleAmount}>
              ...
              >
                ...
                {isShowUpDownIcon.isShow == true
                  ? ` ${isShowUpDownIcon.text} since previous month`
                  : null}
              </Text>
              <Text
                style={{
        ...
        {currentIndex < ExpenseByCategory.length - 1 ? <this.seprator /> : null}
      </Fragment>
    );
  };
  seprator = () => {
  ...
  Labels = ({ slices, height, width }) => {
    return slices.map((slice, index) => {
      ...
      if (data.percentage < 20) return false;
      return (
        ...
        <View style={styles.piechartText}>
          ...
          {isShowUpDownIcon.isShow == false ? (
            ...
            <Fragment>
              ...
              <Text
                style={{ textAlign: "center", color: "#1D1E1F", opacity: 0.5 }}
              >
                since last month
              </Text>
            </Fragment>
