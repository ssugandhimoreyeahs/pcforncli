...
import { View ,Text, TextInput, StyleSheet,TouchableOpacity, BackHandler, SafeAreaView, StatusBar} from "react-native";
  ...
  <React.Fragment>
    ...
    {/* <View style={{flexDirection:'row', width:'100%',marginTop:'1%',justifyContent:'space-between'}}>
        ...
        <View style={{ paddingHorizontal:10,alignSelf:"center",marginTop: 15,flexDirection:"row",width:"100%",justifyContent:"space-between",borderWidth:0,borderColor:"black" }}>
                        ...
                        <Text style={{ fontSize:17,fontWeight:"bold",color:"black" }}>{ `Settings` }</Text>
                        
                            
                        </View>
                        <View style={{ justifyContent:"center",alignItems:"center" }}>
                            <TouchableOpacity onPress={()=>{ 
                              this.props.navigation.navigate("SettingEdit",{ ...userData })
                             }}>
                              <Text style={styles.editView}>Edit</Text>
                            </TouchableOpacity>
                        </View>
    ...
    <View style={styles.container}>
        ...
        <View style={styles.vpass}>
          ...
          <View style={{width:148, height:20, justifyContent:'space-between',alignItems:'center'}}>
          <TouchableOpacity onPress={()=>{ this.props.navigation.navigate("ChangePassword",{ ...userData }) }} style={{flexDirection:'row'}}>
            <Text placeholderTextColor="#000000" style={styles.textdata}>Change password</Text>
...
export default connect(mapStateToProps,null)(DetectPlatfrom(Setting,styles.margins));
