...
import { View ,Text, TextInput, StyleSheet,TouchableOpacity, BackHandler,Alert, Keyboard, SafeAreaView, StatusBar} from "react-native";
// import { AntDesign, Ionicons} from '@expo/vector-icons';
import { Button } from "react-native-elements";
import { editUserSetting } from "../../../api/api";
import Spinner from 'react-native-loading-spinner-overlay';

import { SETTING_UPDATED,CONNECTION_ABORTED,TRY_AGAIN } from "../../../api/message";
 ...
 class SettingEdit extends React.Component{
  ...
  handleSettingEdit = async () => {
      ...
      if(updateUser.result == true){
        ...
        this.setState((prevState)=>{ return { isSpinner: false } },()=>{ setTimeout(()=>{
  ...
  handleSettingSaveButtonEnabledOrDisabled = () => {
      ...
      if(firstname == getParam("firstname") && title == getParam("title") && username == getParam("username") && lastname == getParam("firstname") ){
        return true;
      }else{
          return false;
      }
...
export default connect(null,mapDispatchToProps)(DetectPlatform(SettingEdit,styles.margins));
