      ...
      <View style={styles.margins}>
        <ScrollView style={{ backgroundColor: "#FFF" }}>
          ...
          <View style={styles.voptionContainer}>
            <TouchableOpacity
              onPress={() => this.props.navigation.navigate("Businesspro")}
            >
              ...
              >
                ...
                >
                  ...
                  <Text style={styles.textsubhead}>
                    Chase, QuickBooks, Manage Integration
                  </Text>
                </View>
          ...
          <Text style={styles.headimh2}>
            Status - {userData.bankStatus == "linked" ? "Active" : "Inactive"}
          </Text>
