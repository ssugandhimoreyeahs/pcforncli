...
const PLAIDAPIS = {
  ...
  getOutflowTransactions:
    APIENDPOINT.endPoint + "/plaid/getTransection?Outflow=true",
  getInflowTransactions:
    APIENDPOINT.endPoint + "/plaid/getTransection?Inflow=true",
  //category Api's
  ...
  addCategoryToTransaction:
    APIENDPOINT.endPoint + "/plaid/addCategoryToTransaction",
  getSubCategories: APIENDPOINT.endPoint + "/category/getSubCategories",
  getSubCategoryTransactions:
    APIENDPOINT.endPoint + "/category/getSubCategoryTransactions",
  categoryChangeInAllTransaction:
    APIENDPOINT.endPoint + "/category/categoryChangeInAllTransaction",
  //expsense by category
  expenseByCategoryCurrentMonth:
    APIENDPOINT.endPoint + "/plaid/ExpenseByCategory?currentMonth=true",
  expenseByCategoryPastThreeMonth:
    APIENDPOINT.endPoint + "/plaid/ExpenseByCategory?pastThreeMonth=true",
  expenseByCategoryPastSixMonth:
    APIENDPOINT.endPoint + "/plaid/ExpenseByCategory?pastSixMonth=true",
  expenseByCategoryPastTweleMonth:
    APIENDPOINT.endPoint + "/plaid/ExpenseByCategory?pastTwelveMonth=true",
  expenseByCategoryScreen: (past) =>
    APIENDPOINT.endPoint + `/plaid/ExpenseByCategoryScreen?past=${past}`,
  expenseByCategorySubScreen: (past) =>
    APIENDPOINT.endPoint + `/category/getSubCategoryScreen?past=${past}`,
  expenseByCategorySubScreenGrpah:
    APIENDPOINT.endPoint + `/category/getSubCategoryScreen/graph`,
  //change in cash api
...
const QUICKBOOKSAPIS = {
  ...
  qbCallBackUrl:
    APIENDPOINT.isQuickBookProduction == true
      ? `https://api.cloud9performancesolutions.com/v0.1/quickBooks/callback`
      : APIENDPOINT.endPoint + "/quickBooks/callback",
...
export const EXPENSES_COLOR_CODE = [
  "#DFDF67",
  "#5994B3",
  "#80C871",
  "#7785E9",
